function ContentManagement() {
    return (
      <>
        <div className="overflow-x-auto flex flex-col align-middle gap-y-2 card shadow-lg bg-base-100 p-8  border border-Info">
          <h1 className="sm:text-3xl text-2xl font-medium title-font m-auto">Announcement Management</h1>
