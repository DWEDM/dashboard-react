function TermsOfService({ setActiveMenu }) {
    return (
      <>
        <div className="container mx-auto p-4">
          <div className="card bg-base-200 shadow-md p-12">
            ...
            <section className="mb-6">
              <h2 className="text-2xl mt-6 mb-4 font-semibold">1. Introduction</h2>
            ...
            <section className="mb-6">
              <h2 className="text-2xl mt-6 mb-4 font-semibold">2. User Responsibilities</h2>
              <ul className="flex flex-col gap-y-2 ml-8 list-decimal">
                <li><strong>Personal Data:</strong> Personal Information to be provided by the user to create an account should be as accurate as possible. <a onClick={() => setActiveMenu('privacyPolicy')} className="text-primary">Privacy Policy</a> is found here.</li>
            ...
            <section className="mb-6">
              <h2 className="text-2xl mt-6 mb-4 font-semibold">3. Content Ownership</h2>
              <ul className="flex flex-col gap-y-2 ml-8 list-decimal">
            ...
            <section className="mb-6">
              <h2 className="text-2xl mt-6 mb-4 font-semibold">4. Pet Posting Guidelines</h2>
              <p className=" ml-8"><strong>Responsibility and Platform Limitation of Liability:</strong> While we strive to maintain a safe and reliable community, we cannot guarantee the accuracy, authenticity, or legitimacy of any adoption offers or listings posted by users. Users are solely responsible for verifying the credibility of such offers and engaging in transSee more... or interSee more... at their own discretion.</p>
            </section>
          
            <section className="mb-6">
              <h2 className="text-2xl mt-6 mb-4 font-semibold">5. Adoption Process</h2>
              ...
              <ul className="flex flex-col gap-y-1 ml-8 mb-4 list-decimal">
                <li>Adoption Code</li>
            ...
            <section className="mb-6">
              <h2 className="text-2xl mt-6 mb-4 font-semibold">6. Indemnification</h2>
              <p className=" ml-8">You agree to indemnify and hold harmless Paws'N Claws, its officers, directors, employees, agents, and affiliates from and against any claims, liabilities, damages, losses, costs, and expenses (including reasonable legal fees) arising out of or related to your use of the platform, your violation of these Terms of Service, or your violation of any rights of another party.</p>
            </section>
          
            <section className="mb-6">
              <h2 className="text-2xl mt-6 mb-4 font-semibold">7. Termination</h2>
              <h3 className="text-xl font-semibold ml-8">1. Termination of Access</h3>
              <p className=" ml-8 mb-4">Paws'N Claws reserves the right to suspend, restrict, or terminate your access to the website and its services at any time, without prior notice, if you violate these Terms of Service or engage in activities deemed harmful to the platform or its users.</p>
              
              <h3 className="text-xl font-semibold ml-8">2. Grounds for Account Termination</h3>
              <ul className="flex flex-col gap-y-2 ml-20 mb-4 list-decimal">
              ...
              <h3 className="text-xl font-semibold ml-8">3. Consequences of Termination</h3>
              <p className=" ml-8">Upon termination, your account will be deactivated, and access to your data, posts, or content may be restricted or permanently removed. Paws'N Claws is not obligated to restore or reinstate accounts that have been terminated for violations of these Terms of Service.</p>
            </section>
          
            <section className="mb-6">
              <h2 className="text-2xl mt-6 mb-4 font-semibold">8. Dispute Resolution</h2>
              <p className=" ml-8">Any disputes between you and Paws'N Claws arising from your use of the platform or these Terms of Service will first be addressed through informal resolution. If unresolved, disputes will be resolved through binding arbitration under Philippine Dispute Resolution Center, Inc. (PDRCI) rules, governed by the Philippine Laws. Claims must be brought individually, not as part of a class or collective action.</p>
            </section>
          
            <section className="mb-6">
              <h2 className="text-2xl mt-6 mb-4 font-semibold">9. Miscellaneous</h2>
              <ul className="flex flex-col gap-y-2 ml-8 list-decimal">
            ...
            <section className="mb-6">
              <h2 className="text-2xl mt-6 mb-4 font-semibold">Copyright Infringement Disclaimer</h2>
              ...
              <p>If you believe your copyright has been infringed, please contact us at <a href="mailto:ad.official.pawsnclaws@gmail.com" className="text-primary">ad.official.pawsnclaws@gmail.com</a>, and we will take appropriate action, including removal or restriction of access to the infringing content.</p>
            </section>
          </div>
        </div>
      </>
